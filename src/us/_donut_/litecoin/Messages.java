...
class Messages {
    ...
    private void loadDefaults() {
        ...
        if (messagesConfig.getStringList("help_command").get(7).equalsIgnoreCase("&3/litecoin top: &bView players with the most litecoins")) { messagesConfig.set("help_command", Arrays.asList(" ", "&9<<< Litecoin Commands >>>", "&3/litecoin help: &bDisplay this page", "&3/litecoin value: &bView current litecoin value", "&3/litecoin stats [player]: &bView player stats", "&3/litecoin bank: &bView amount of litecoins in bank", "&3/litecoin tax: &bView the current purchase tax", "&3/litecoin circulation: &bView circulation info",  "&3/litecoin top: &bView players with the most litecoins", "&3/litecoin mine: &bOpen mining interface", "&3/litecoin transfer <player> <amount>: &bTransfer litecoins", "&3/litecoin sell <amount>: &bSell litecoins", "&3/litecoin buy <amount>: &bBuy litecoins", "&3/litecoin give <player> <amount>: &bAdd to balance", "&3/litecoin remove <player> <amount>: &bRemove from balance", "&3/litecoin set <player> <amount>: &bSet balance", "&3/litecoin reload: &bReload plugin", "&3/litecoin cancel: &bCancel transfer/purchase/sell")); }
